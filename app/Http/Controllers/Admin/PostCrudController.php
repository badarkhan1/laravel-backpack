...
class PostCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addColumns(['name' , 'no_of_columns']); // add multiple columns, at the end of the stack
        // $this->crud->removeColumn('no_of_columns'); // remove a column from the stack
